...
CREATE TABLE tb_m_4s_opt_changes(
	opt_changes_4s_id INT GENERATED BY DEFAULT AS IDENTITY primary key,
	uuid UUID not null,
...
CREATE TABLE tb_r_4s_sub_schedules(
	...
	constraint fk_tb_r_4s_sub_schedules_pic foreign key (pic_id) references tb_m_users (user_id),
